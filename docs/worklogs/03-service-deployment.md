...
| Helm 4 | `ansible/playbooks/group_vars/all.yml`, `tests/`, `docs/decisions/0005-kubernetes-bootstrap-architecture.md` | Helm CLI pin moved from 3.22.0 to 4.3.0 on 2026-09-26 because Helm 3 security fixes end on 2027-02-10. The Traefik install tasks and flags are unchanged. See the [decision 0005 amendment](../decisions/0005-kubernetes-bootstrap-architecture.md#amendment-helm-4). Not yet validated on the cluster. |
