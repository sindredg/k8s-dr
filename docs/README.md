...
| [Service deployment architecture](decisions/0006-service-deployment-architecture.md) | Propose Flux, secrets, PostgreSQL, Gitea, and public exposure for milestone 3. |
